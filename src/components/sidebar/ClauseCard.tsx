...
export function ClauseCard({ item, inDraft, onToggle, onDelete, onExplain, onReplace, compact, suggested }: ClauseCardProps) {
  return (
    <div className={cn(
      ...
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0 flex-1 space-y-1">
          <div className="flex items-center gap-1.5">
            <Badge variant="outline" className="shrink-0 h-5 px-1.5 text-xs font-medium text-amber-600 border-amber-300">
              CLAUSE
            </Badge>
